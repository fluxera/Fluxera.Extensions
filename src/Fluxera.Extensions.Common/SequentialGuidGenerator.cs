namespace Fluxera.Extensions.Common
{
	...
	/// <summary>
	///     Implements <see cref="IGuidGenerator" /> by creating sequential <see cref="Guid" />s.
	///     Use <see cref="SequentialGuidGeneratorOptions" /> to configure.
	/// </summary>
	/// <remarks>
	///     See: https://github.com/jhtodd/SequentialGuid/blob/master/SequentialGuid/Classes/SequentialGuid.cs
	/// </remarks>
	[UsedImplicitly]
